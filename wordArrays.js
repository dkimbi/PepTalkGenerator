...
// column one of words
const columnThree = [
"has a serious,", "rains magic,", "deserves the Nobel Prize,", "raises the roof,", "breed miracles,", "is paying off big time,", "shows mad skills,","just shimmers,","is national treasure,","gets the party hopping,","the next big thing,","roars like a lion,","is a rainbow factory,","is made of diamonds,","makes birds sing,","should be taught in school,","makes my world go round,","is 100% legit,"
	];
...
index_num4 = Math.floor(Math.random() * 11);
//console.log(index_num)
console.log(columnOne[index_num1])
console.log(columnTwo[index_num2])
